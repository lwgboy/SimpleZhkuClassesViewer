...
public class CourseAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		TextView courseTeacher = (TextView) arg1
				.findViewById(R.id.course_teacher);
		TextView courseWeeks = (TextView) arg1.findViewById(R.id.course_weeks);
		TextView courseclasses = (TextView) arg1
				.findViewById(R.id.course_classes);
		TextView courseClassroom = (TextView) arg1
				.findViewById(R.id.course_classroom);
	...
	// TextView courseName = (TextView) arg1.findViewById(R.id.course_name);
	// TextView courseTeacher = (TextView)
	// arg1.findViewById(R.id.course_teacher);
	// TextView courseWeeks = (TextView) arg1.findViewById(R.id.course_weeks);
	// TextView courseclasses = (TextView)
	// arg1.findViewById(R.id.course_classes);
	// TextView courseClassroom = (TextView)
	// arg1.findViewById(R.id.course_classroom);
	//
	// CourseBean c = courseBeans.get(arg0);
	//
	...
	// if(!courseClassroom.isShown())
	// courseClassroom.setVisibility(View.VISIBLE);
	//
